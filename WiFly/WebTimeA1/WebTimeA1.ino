...
{
wifi.SendCommand("set", "wlan", "auth", 4); 
  //wifi.SendCommand(set wlan auth,4,AOK);
//WiFly.SendCommand("set wlan key <value>","AOK");
wifi.SendCommand("set", "wlan", "channel",0);
wifi.SendCommand("set", "wlan", "join", 1);
wifi.SendCommand("set", "wlan", "dhcp", 1);
//wifi.SendCommand("save", "my_config");
